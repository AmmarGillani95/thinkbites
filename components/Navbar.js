...
export default function Navbar() {
  ...
  return (
    <div className="dark:bg-darkNavy bg-salmon">
      <nav className="flex justify-between  py-2 md:py-4 items-center max-w-5xl w-fill mx-auto  px-8 bg">
        <NextLink
          href="/"
        ...
        >
          ...
          <p className="hidden sm:block lowercase  text-xl font-semibold  leading-none tracking-widest text-navy dark:text-salmon">
            Thinkbites
          </p>
        </NextLink>
        <div className="space-x-4 leading-none  flex items-center">
          ...
          <div className="fixed lg:static top-3 right-6 z-50">
